...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute aparece en una filtración de datos. Elija otro valor.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'location_id' => 'sede',
        'service_id' => 'servicio',
        'service_pack_id' => 'pack de servicio',
        'client_id' => 'cliente',
        'client_pack_id' => 'pack del cliente',
        'booking_id' => 'reserva',
        ...
        'status' => 'estado',
        'custom_duration_minutes' => 'duración personalizada',
    ],
